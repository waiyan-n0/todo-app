...
function Sidebar(){
    ...
    return (
        <div className='flex flex-col h-full bg-gray-900/50 backdrop-blur-md text-gray-300 p-6 space-y-8 w-64 border-r border-gray-800 text-left'>
            ...
            <div className='flex flex-col '>
                ...
                <div className='flex flex-col gap-1 '>
                    <span
                        ...
                        <svg
                            className="w-6 h-6 text-gray-800 dark:text-white transition-transform duration-200 group-hover:scale-110"
            ...
            <div className='flex flex-col gap-1'>
                ...
                <div className='flex flex-col gap-1'>
                    ...
                    <span className='group flex gap-2 font-semibold px-2 py-1 opacity-70 text-sm cursor-pointer hover:bg-sky-500/10 hover:text-sky-400 shadow-[inset_0_0_10px_rgba(14,165,233,0.1)'>
                        <svg className="w-6 h-6 text-gray-800 dark:text-white transition-transform duration-200 group-hover:scale-110" aria-hidden="true"
                             xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                             viewBox="0 0 24 24">
                          <path fillRule="evenodd"
